...
public class ConsultantRegistrationPageFifthThreeActivity extends BaseActivity {

    @Override
    protected final void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState,R.layout.activity_consultant_registration_page_fifth_three);
        initToolbar("Проффесиональные навыки");
    }
