...
public class FavoriteConsultantsAdapter extends RecyclerView.Adapter<FavoriteConsultantsAdapter.ViewHolder> {
        ...
        public ViewHolder(CardView cv){
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View v) {
                    Intent intent = new Intent(cardView.getContext(), ConsultantProfileActivity.class);
    ...
    @Override
    public FavoriteConsultantsAdapter.ViewHolder onCreateViewHolder(
            ViewGroup parent, int viewType){
        CardView cv = (CardView) LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_customer_favorite_cards, parent, false);
        return new ViewHolder(cv);
    }
    public FavoriteConsultantsAdapter(String[] firstName,String[] middleName){
